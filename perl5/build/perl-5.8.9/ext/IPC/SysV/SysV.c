...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Msg::stat::unpack", "obj, ds");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::SharedMem::stat::pack", "obj");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::SharedMem::stat::unpack", "obj, ds");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::SysV::ftok", "path, id = &PL_sv_undef");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::SysV::memread", "addr, sv, pos, size");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	addr = ST(0);
	SV *	sv = ST(1);
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::SysV::memwrite", "addr, sv, pos, size");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	addr = ST(0);
	SV *	sv = ST(1);
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::SysV::shmat", "id, addr, flag");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::SysV::shmdt", "addr");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	addr = ST(0);
#line 406 "SysV.xs"
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::SysV::_constant", "sv");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
XS(boot_IPC__SysV)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("IPC::SharedMem::stat::pack", XS_IPC__SharedMem__stat_pack, file, "$");
        newXSproto("IPC::SharedMem::stat::unpack", XS_IPC__SharedMem__stat_unpack, file, "$$");
        newXSproto("IPC::SysV::ftok", XS_IPC__SysV_ftok, file, "$;$");
        newXSproto("IPC::SysV::memread", XS_IPC__SysV_memread, file, "$$$$");
        newXSproto("IPC::SysV::memwrite", XS_IPC__SysV_memwrite, file, "$$$$");
        newXSproto("IPC::SysV::shmat", XS_IPC__SysV_shmat, file, "$$$");
        newXSproto("IPC::SysV::shmdt", XS_IPC__SysV_shmdt, file, "$");
        newXSproto("IPC::SysV::_constant", XS_IPC__SysV__constant, file, "$");
    XSRETURN_YES;
}
