...
"x86_64-linux-2.6.32-37-generic" or
	die "Errno architecture (x86_64-linux-2.6.32-37-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
