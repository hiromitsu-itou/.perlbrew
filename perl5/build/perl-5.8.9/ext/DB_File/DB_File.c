 ...
 * contents of DB_File.xs. Do not edit this file, edit DB_File.xs instead.
 *
...
/* INCLUDE:  Including 'constants.xs' from 'DB_File.xs' */


XS(XS_DB_File_constant); /* prototype to pass -Wmissing-prototypes */
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::constant", "sv");
	...
	type = constant(aTHX_ s, len, &iv);
      /* Return 1 or 2 items. First is error message, or undef if no error.
        ...
        case PERL_constant_NOTFOUND:
          sv =
	    sv_2mortal(newSVpvf("%s is not a valid DB_File macro", s));
          PUSHs(sv);
          break;
...
/* INCLUDE: Returning to 'DB_File.xs' from 'constants.xs' */


XS(XS_DB_File_DoTie_); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_DoTie_)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 6)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::DoTie_", "isHASH, dbtype, name=undef, flags=O_CREAT|O_RDWR, mode=0666, type=DB_HASH");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	isHASH = (int)SvIV(ST(0));
	char *	dbtype = (char *)SvPV_nolen(ST(1));
	int	flags;
	int	mode;
	DB_File	RETVAL;
...
XS(XS_DB_File_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::DESTROY", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
#line 1540 "DB_File.xs"
	  dMY_CXT;
#line 1688 "DB_File.c"
	int	RETVAL;
	dXSTARG;
	...
	if (SvROK(ST(0))) {
	    ...
	    db = INT2PTR(DB_File,tmp);
	}
	else
	    Perl_croak(aTHX_ "%s: %s is not a reference",
			"DB_File::DESTROY",
			"db");
#line 1542 "DB_File.xs"
	  CurrentDB = db ;
	  Trace(("DESTROY %p\n", db));
#line 1703 "DB_File.c"
...
XS(XS_DB_File_DELETE); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_DELETE)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::DELETE", "db, key, flags=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
	u_int	flags;
#line 1573 "DB_File.xs"
	  dMY_CXT;
#line 1751 "DB_File.c"
	int	RETVAL;
	dXSTARG;

	if (sv_derived_from(ST(0), "DB_File")) {
	    IV tmp = SvIV((SV*)SvRV(ST(0)));
	    db = INT2PTR(DB_File,tmp);
	}
	else
...
XS(XS_DB_File_EXISTS); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_EXISTS)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::EXISTS", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
#line 1583 "DB_File.xs"
	  dMY_CXT;
#line 1816 "DB_File.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_DB_File_FETCH); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_FETCH)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::FETCH", "db, key, flags=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
	u_int	flags;
#line 1601 "DB_File.xs"
	  dMY_CXT ;
	  int RETVAL ;
#line 1881 "DB_File.c"
...
XS(XS_DB_File_STORE); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_STORE)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
#endif
    if (items < 3 || items > 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::STORE", "db, key, value, flags=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
...
XS(XS_DB_File_FIRSTKEY); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_FIRSTKEY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::FIRSTKEY", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
#line 1630 "DB_File.xs"
	  dMY_CXT ;
	  int RETVAL ;
#line 2028 "DB_File.c"
...
XS(XS_DB_File_NEXTKEY); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_NEXTKEY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::NEXTKEY", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
#line 1650 "DB_File.xs"
	  dMY_CXT ;
	  int RETVAL ;
#line 2073 "DB_File.c"
...
XS(XS_DB_File_unshift); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_unshift)
{
    ...
    dXSI32;
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", GvNAME(CvGV(cv)), "db, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
#line 1673 "DB_File.xs"
	  dMY_CXT;
#line 2116 "DB_File.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_DB_File_pop); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_pop)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    {
	DB_File	db;
#line 1716 "DB_File.xs"
	  dMY_CXT;
#line 2186 "DB_File.c"
#line 1719 "DB_File.xs"
	  I32 RETVAL;
#line 2189 "DB_File.c"
...
XS(XS_DB_File_shift); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_shift)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    {
	DB_File	db;
#line 1747 "DB_File.xs"
	  dMY_CXT;
#line 2243 "DB_File.c"
#line 1750 "DB_File.xs"
	  I32 RETVAL;
#line 2246 "DB_File.c"
...
XS(XS_DB_File_push); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_push)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_DB_File_length); /* prototype to pass -Wmissing-prototypes */
...
XS(XS_DB_File_del); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_del)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::del", "db, key, flags=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
	u_int	flags;
#line 1842 "DB_File.xs"
	  dMY_CXT;
#line 2409 "DB_File.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_DB_File_get); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_get)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
#endif
    if (items < 3 || items > 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::get", "db, key, value, flags=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
...
XS(XS_DB_File_put); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_put)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
#endif
    if (items < 3 || items > 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::put", "db, key, value, flags=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
...
XS(XS_DB_File_fd); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_fd)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::fd", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
#line 1903 "DB_File.xs"
	  dMY_CXT ;
#line 2639 "DB_File.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_DB_File_sync); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_sync)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::sync", "db, flags=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	u_int	flags;
#line 1929 "DB_File.xs"
	  dMY_CXT;
#line 2691 "DB_File.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_DB_File_seq); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_seq)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::seq", "db, key, value, flags");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	DBTKEY	key;
	DBT	value;
	u_int	flags = (unsigned int)SvUV(ST(3));
#line 1948 "DB_File.xs"
	  dMY_CXT;
#line 2741 "DB_File.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_DB_File_filter_fetch_key); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_filter_fetch_key)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::filter_fetch_key", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	SV *	code = ST(1);
...
XS(XS_DB_File_filter_store_key); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_filter_store_key)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::filter_store_key", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	SV *	code = ST(1);
...
XS(XS_DB_File_filter_fetch_value); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_filter_fetch_value)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::filter_fetch_value", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	SV *	code = ST(1);
...
XS(XS_DB_File_filter_store_value); /* prototype to pass -Wmissing-prototypes */
XS(XS_DB_File_filter_store_value)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DB_File::filter_store_value", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	DB_File	db;
	SV *	code = ST(1);
...
extern "C"
#endif
XS(boot_DB_File); /* prototype to pass -Wmissing-prototypes */
XS(boot_DB_File)
{
#ifdef dVAR
    dVAR; dXSARGS;
...

    {
        ...
        newXS("DB_File::DoTie_", XS_DB_File_DoTie_, file);
        newXS("DB_File::DESTROY", XS_DB_File_DESTROY, file);
        newXS("DB_File::DELETE", XS_DB_File_DELETE, file);
        newXS("DB_File::EXISTS", XS_DB_File_EXISTS, file);
        newXS("DB_File::FETCH", XS_DB_File_FETCH, file);
        newXS("DB_File::STORE", XS_DB_File_STORE, file);
        newXS("DB_File::FIRSTKEY", XS_DB_File_FIRSTKEY, file);
        newXS("DB_File::NEXTKEY", XS_DB_File_NEXTKEY, file);
        cv = newXS("DB_File::UNSHIFT", XS_DB_File_unshift, file);
        XSANY.any_i32 = 1 ;
        cv = newXS("DB_File::unshift", XS_DB_File_unshift, file);
        XSANY.any_i32 = 0 ;
        cv = newXS("DB_File::POP", XS_DB_File_pop, file);
        XSANY.any_i32 = 1 ;
        cv = newXS("DB_File::pop", XS_DB_File_pop, file);
        XSANY.any_i32 = 0 ;
        cv = newXS("DB_File::SHIFT", XS_DB_File_shift, file);
        XSANY.any_i32 = 1 ;
        cv = newXS("DB_File::shift", XS_DB_File_shift, file);
        XSANY.any_i32 = 0 ;
        cv = newXS("DB_File::push", XS_DB_File_push, file);
        XSANY.any_i32 = 0 ;
        cv = newXS("DB_File::PUSH", XS_DB_File_push, file);
        XSANY.any_i32 = 1 ;
        cv = newXS("DB_File::length", XS_DB_File_length, file);
        XSANY.any_i32 = 0 ;
        cv = newXS("DB_File::FETCHSIZE", XS_DB_File_length, file);
        XSANY.any_i32 = 1 ;
        newXS("DB_File::del", XS_DB_File_del, file);
        newXS("DB_File::get", XS_DB_File_get, file);
        newXS("DB_File::put", XS_DB_File_put, file);
        newXS("DB_File::fd", XS_DB_File_fd, file);
        newXS("DB_File::sync", XS_DB_File_sync, file);
        newXS("DB_File::seq", XS_DB_File_seq, file);
        newXS("DB_File::filter_fetch_key", XS_DB_File_filter_fetch_key, file);
        newXS("DB_File::filter_store_key", XS_DB_File_filter_store_key, file);
        newXS("DB_File::filter_fetch_value", XS_DB_File_filter_fetch_value, file);
        newXS("DB_File::filter_store_value", XS_DB_File_filter_store_value, file);
    }

    /* Initialisation Section */

#line 1492 "DB_File.xs"
  {
#ifdef dTHX
    dTHX;
#endif    
