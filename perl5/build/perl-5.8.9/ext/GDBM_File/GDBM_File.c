...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::constant", "sv");
...
#endif
    if (items < 4 || items > 5)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::TIEHASH", "dbtype, name, read_write, mode, fatal_func = (FATALFUNC)croak");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::close", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::DESTROY", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::FETCH", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	datum_key_copy	key;
...
#endif
    if (items < 3 || items > 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::STORE", "db, key, value, flags = GDBM_REPLACE");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	datum_key	key;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::DELETE", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	datum_key	key;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::FIRSTKEY", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	datum_key	RETVAL;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::NEXTKEY", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	datum_key	key;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::reorganize", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	int	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::sync", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::EXISTS", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	datum_key	key;
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::setopt", "db, optflag, optval, optlen");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::filter_fetch_key", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	SV *	code = ST(1);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::filter_store_key", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	SV *	code = ST(1);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::filter_fetch_value", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	SV *	code = ST(1);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "GDBM_File::filter_store_value", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	GDBM_File	db;
	SV *	code = ST(1);
