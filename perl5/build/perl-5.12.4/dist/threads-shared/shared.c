...
#if XSubPPtmpAAAA
        (void)newXS("threads::shared::tie::PUSH", XS_threads__shared__tie_PUSH, file);
        (void)newXS("threads::shared::tie::UNSHIFT", XS_threads__shared__tie_UNSHIFT, file);
        (void)newXS("threads::shared::tie::POP", XS_threads__shared__tie_POP, file);
        (void)newXS("threads::shared::tie::SHIFT", XS_threads__shared__tie_SHIFT, file);
        (void)newXS("threads::shared::tie::EXTEND", XS_threads__shared__tie_EXTEND, file);
        (void)newXS("threads::shared::tie::STORESIZE", XS_threads__shared__tie_STORESIZE, file);
        (void)newXS("threads::shared::tie::EXISTS", XS_threads__shared__tie_EXISTS, file);
        (void)newXS("threads::shared::tie::FIRSTKEY", XS_threads__shared__tie_FIRSTKEY, file);
        (void)newXS("threads::shared::tie::NEXTKEY", XS_threads__shared__tie_NEXTKEY, file);
