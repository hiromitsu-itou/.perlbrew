...
XS(XS_Storable_pstore)
{
	...
	int	RETVAL;
	dXSTARG;
#line 6420 "Storable.xs"
  RETVAL = pstore(aTHX_ f, obj);
#line 6503 "Storable.c"
...
XS(XS_Storable_net_pstore)
{
	...
	int	RETVAL;
	dXSTARG;
#line 6429 "Storable.xs"
  RETVAL = net_pstore(aTHX_ f, obj);
#line 6527 "Storable.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Storable_mstore)
{
	...
	SV *	obj = ST(0);
	SV *	RETVAL;
#line 6437 "Storable.xs"
  RETVAL = mstore(aTHX_ obj);
#line 6549 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Storable_net_mstore)
{
	...
	SV *	obj = ST(0);
	SV *	RETVAL;
#line 6445 "Storable.xs"
  RETVAL = net_mstore(aTHX_ obj);
#line 6572 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Storable_mretrieve)
{
	...
	SV *	sv = ST(0);
	SV *	RETVAL;
#line 6461 "Storable.xs"
  RETVAL = mretrieve(aTHX_ sv);
#line 6618 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Storable_is_retrieving)
{
	...
	int	RETVAL;
	dXSTARG;
#line 6490 "Storable.xs"
  RETVAL = is_retrieving(aTHX);
#line 6708 "Storable.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(boot_Storable)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("Storable::Cxt::DESTROY", XS_Storable__Cxt_DESTROY, file);
        (void)newXSproto_portable("Storable::init_perinterp", XS_Storable_init_perinterp, file, "");
        (void)newXSproto_portable("Storable::pstore", XS_Storable_pstore, file, "$$");
        (void)newXSproto_portable("Storable::net_pstore", XS_Storable_net_pstore, file, "$$");
        (void)newXSproto_portable("Storable::mstore", XS_Storable_mstore, file, "$");
        (void)newXSproto_portable("Storable::net_mstore", XS_Storable_net_mstore, file, "$");
        ...
        (void)newXSproto_portable("Storable::is_storing", XS_Storable_is_storing, file, "");
        (void)newXSproto_portable("Storable::is_retrieving", XS_Storable_is_retrieving, file, "");

    /* Initialisation Section */

#line 6393 "Storable.xs"
{
