...
XS(XS_threads_self)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1148 "threads.xs"
        char *classname;
        ithread *thread;
#line 1249 "threads.c"
#line 1151 "threads.xs"
        /* Class method only */
...
XS(XS_threads_tid)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1166 "threads.xs"
        ithread *thread;
#line 1279 "threads.c"
#line 1168 "threads.xs"
...
XS(XS_threads__handle)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1462 "threads.xs"
        ithread *thread;
#line 1680 "threads.c"
#line 1464 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
#ifdef WIN32
...
XS(XS_threads_set_stack_size)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1496 "threads.xs"
        IV old_size;
        dMY_POOL;
#line 1741 "threads.c"
#line 1499 "threads.xs"
        if (items != 2) {
...
XS(XS_threads_is_running)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1518 "threads.xs"
        ithread *thread;
#line 1775 "threads.c"
#line 1520 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS(XS_threads_is_joinable)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1548 "threads.xs"
        ithread *thread;
#line 1831 "threads.c"
#line 1550 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS(XS_threads_set_thread_exit_only)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1580 "threads.xs"
        ithread *thread;
#line 1889 "threads.c"
#line 1582 "threads.xs"
        if (items != 2) {
...
#if XSubPPtmpAAAA
        (void)newXS("threads::create", XS_threads_create, file);
        (void)newXS("threads::list", XS_threads_list, file);
        (void)newXS("threads::self", XS_threads_self, file);
        (void)newXS("threads::tid", XS_threads_tid, file);
        (void)newXS("threads::join", XS_threads_join, file);
        (void)newXS("threads::yield", XS_threads_yield, file);
        (void)newXS("threads::detach", XS_threads_detach, file);
        (void)newXS("threads::kill", XS_threads_kill, file);
        (void)newXS("threads::DESTROY", XS_threads_DESTROY, file);
        (void)newXS("threads::equal", XS_threads_equal, file);
        (void)newXS("threads::object", XS_threads_object, file);
        (void)newXS("threads::_handle", XS_threads__handle, file);
        (void)newXS("threads::get_stack_size", XS_threads_get_stack_size, file);
        (void)newXS("threads::set_stack_size", XS_threads_set_stack_size, file);
        (void)newXS("threads::is_running", XS_threads_is_running, file);
        (void)newXS("threads::is_detached", XS_threads_is_detached, file);
        (void)newXS("threads::is_joinable", XS_threads_is_joinable, file);
        (void)newXS("threads::wantarray", XS_threads_wantarray, file);
        (void)newXS("threads::set_thread_exit_only", XS_threads_set_thread_exit_only, file);
        (void)newXS("threads::error", XS_threads_error, file);
#endif
