...
case "$perladmin" in
'') perladmin='ito@ito.ad.ngigroup.com' ;;
esac
...
case "$prefix" in
'') prefix='/home/ito/.perlbrew/perl5/perls/perl-5.12.4' ;;
esac
...
case "$siteprefix" in
'') if test "/home/ito/.perlbrew/perl5/perls/perl-5.12.4" = "/home/ito/.perlbrew/perl5/perls/perl-5.12.4"; then
	siteprefix="$prefix"
    else
	siteprefix='/home/ito/.perlbrew/perl5/perls/perl-5.12.4'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "/home/ito/.perlbrew/perl5/perls/perl-5.12.4"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
'') if test "/home/ito/.perlbrew/perl5/perls/perl-5.12.4" = "/home/ito/.perlbrew/perl5/perls/perl-5.12.4"; then
	...
	installprefix='/home/ito/.perlbrew/perl5/perls/perl-5.12.4'
    fi
    ;;
esac
...
#     /home/ito/.perlbrew/perl5/perls/perl-5.12.4, so it isn't included here either.
#
...
# archlib='/home/ito/.perlbrew/perl5/perls/perl-5.12.4/lib/5.12.4/x86_64-linux'
...
html3dir=' '
# sitebin='/home/ito/.perlbrew/perl5/perls/perl-5.12.4/bin'
# sitescript='/home/ito/.perlbrew/perl5/perls/perl-5.12.4/bin'
# sitelib='/home/ito/.perlbrew/perl5/perls/perl-5.12.4/lib/site_perl/5.12.4'
# sitearch='/home/ito/.perlbrew/perl5/perls/perl-5.12.4/lib/site_perl/5.12.4/x86_64-linux'
# Preserving custom siteman1dir
siteman1dir='/home/ito/.perlbrew/perl5/perls/perl-5.12.4/man/man1'
# Preserving custom siteman3dir
siteman3dir='/home/ito/.perlbrew/perl5/perls/perl-5.12.4/man/man3'
