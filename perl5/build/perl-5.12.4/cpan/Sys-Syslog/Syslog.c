...
XS(boot_Sys__Syslog)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("Sys::Syslog::constant", XS_Sys__Syslog_constant, file);
        (void)newXS("Sys::Syslog::LOG_FAC", XS_Sys__Syslog_LOG_FAC, file);
        (void)newXS("Sys::Syslog::LOG_PRI", XS_Sys__Syslog_LOG_PRI, file);
        (void)newXS("Sys::Syslog::LOG_MAKEPRI", XS_Sys__Syslog_LOG_MAKEPRI, file);
        (void)newXS("Sys::Syslog::LOG_MASK", XS_Sys__Syslog_LOG_MASK, file);
        (void)newXS("Sys::Syslog::LOG_UPTO", XS_Sys__Syslog_LOG_UPTO, file);
#if XSubPPtmpAAAA
        (void)newXS("Sys::Syslog::openlog_xs", XS_Sys__Syslog_openlog_xs, file);
        (void)newXS("Sys::Syslog::syslog_xs", XS_Sys__Syslog_syslog_xs, file);
        (void)newXS("Sys::Syslog::setlogmask_xs", XS_Sys__Syslog_setlogmask_xs, file);
        (void)newXS("Sys::Syslog::closelog_xs", XS_Sys__Syslog_closelog_xs, file);
#endif
#if XSubPPtmpAAAB
        (void)newXS("Sys::Syslog::openlog_xs", XS_Sys__Syslog_openlog_xs, file);
        (void)newXS("Sys::Syslog::syslog_xs", XS_Sys__Syslog_syslog_xs, file);
