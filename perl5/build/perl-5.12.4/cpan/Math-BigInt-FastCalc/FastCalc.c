...
XS(boot_Math__BigInt__FastCalc)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("Math::BigInt::FastCalc::_set_XS_BASE", XS_Math__BigInt__FastCalc__set_XS_BASE, file);
        (void)newXS("Math::BigInt::FastCalc::_new", XS_Math__BigInt__FastCalc__new, file);
        (void)newXS("Math::BigInt::FastCalc::_copy", XS_Math__BigInt__FastCalc__copy, file);
        (void)newXS("Math::BigInt::FastCalc::__strip_zeros", XS_Math__BigInt__FastCalc___strip_zeros, file);
        (void)newXS("Math::BigInt::FastCalc::_dec", XS_Math__BigInt__FastCalc__dec, file);
        (void)newXS("Math::BigInt::FastCalc::_inc", XS_Math__BigInt__FastCalc__inc, file);
        (void)newXS("Math::BigInt::FastCalc::_num", XS_Math__BigInt__FastCalc__num, file);
        (void)newXS("Math::BigInt::FastCalc::_zero", XS_Math__BigInt__FastCalc__zero, file);
        (void)newXS("Math::BigInt::FastCalc::_one", XS_Math__BigInt__FastCalc__one, file);
        (void)newXS("Math::BigInt::FastCalc::_two", XS_Math__BigInt__FastCalc__two, file);
        (void)newXS("Math::BigInt::FastCalc::_ten", XS_Math__BigInt__FastCalc__ten, file);
        (void)newXS("Math::BigInt::FastCalc::_is_even", XS_Math__BigInt__FastCalc__is_even, file);
        (void)newXS("Math::BigInt::FastCalc::_is_odd", XS_Math__BigInt__FastCalc__is_odd, file);
        (void)newXS("Math::BigInt::FastCalc::_is_one", XS_Math__BigInt__FastCalc__is_one, file);
        (void)newXS("Math::BigInt::FastCalc::_is_two", XS_Math__BigInt__FastCalc__is_two, file);
        (void)newXS("Math::BigInt::FastCalc::_is_ten", XS_Math__BigInt__FastCalc__is_ten, file);
        (void)newXS("Math::BigInt::FastCalc::_is_zero", XS_Math__BigInt__FastCalc__is_zero, file);
        (void)newXS("Math::BigInt::FastCalc::_len", XS_Math__BigInt__FastCalc__len, file);
        (void)newXS("Math::BigInt::FastCalc::_acmp", XS_Math__BigInt__FastCalc__acmp, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
