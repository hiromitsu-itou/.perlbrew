...
XS(boot_SDBM_File)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("SDBM_File::TIEHASH", XS_SDBM_File_TIEHASH, file);
        (void)newXS("SDBM_File::DESTROY", XS_SDBM_File_DESTROY, file);
        (void)newXS("SDBM_File::FETCH", XS_SDBM_File_FETCH, file);
        (void)newXS("SDBM_File::STORE", XS_SDBM_File_STORE, file);
        (void)newXS("SDBM_File::DELETE", XS_SDBM_File_DELETE, file);
        (void)newXS("SDBM_File::EXISTS", XS_SDBM_File_EXISTS, file);
        (void)newXS("SDBM_File::FIRSTKEY", XS_SDBM_File_FIRSTKEY, file);
        (void)newXS("SDBM_File::NEXTKEY", XS_SDBM_File_NEXTKEY, file);
        (void)newXS("SDBM_File::error", XS_SDBM_File_error, file);
        (void)newXS("SDBM_File::clearerr", XS_SDBM_File_clearerr, file);
        (void)newXS("SDBM_File::filter_fetch_key", XS_SDBM_File_filter_fetch_key, file);
        (void)newXS("SDBM_File::filter_store_key", XS_SDBM_File_filter_store_key, file);
        (void)newXS("SDBM_File::filter_fetch_value", XS_SDBM_File_filter_fetch_value, file);
        (void)newXS("SDBM_File::filter_store_value", XS_SDBM_File_filter_store_value, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
