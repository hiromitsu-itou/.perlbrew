...
XS(boot_Devel__Peek)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("Devel::Peek::mstat", XS_Devel__Peek_mstat, file);
        (void)newXS("Devel::Peek::fill_mstats", XS_Devel__Peek_fill_mstats, file);
        ...
        (void)newXS("Devel::Peek::Dump", XS_Devel__Peek_Dump, file);
        (void)newXS("Devel::Peek::DumpArray", XS_Devel__Peek_DumpArray, file);
        (void)newXS("Devel::Peek::DumpProg", XS_Devel__Peek_DumpProg, file);
        (void)newXS("Devel::Peek::SvREFCNT", XS_Devel__Peek_SvREFCNT, file);
        (void)newXS("Devel::Peek::SvREFCNT_inc", XS_Devel__Peek_SvREFCNT_inc, file);
        (void)newXS("Devel::Peek::SvREFCNT_dec", XS_Devel__Peek_SvREFCNT_dec, file);
        (void)newXS("Devel::Peek::DeadCode", XS_Devel__Peek_DeadCode, file);
        (void)newXS("Devel::Peek::CvGV", XS_Devel__Peek_CvGV, file);
        (void)newXS("Devel::Peek::runops_debug", XS_Devel__Peek_runops_debug, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
