...
XS(boot_Socket)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("Socket::constant", XS_Socket_constant, file);
        (void)newXS("Socket::inet_aton", XS_Socket_inet_aton, file);
        (void)newXS("Socket::inet_ntoa", XS_Socket_inet_ntoa, file);
        (void)newXS("Socket::sockaddr_family", XS_Socket_sockaddr_family, file);
        (void)newXS("Socket::pack_sockaddr_un", XS_Socket_pack_sockaddr_un, file);
        (void)newXS("Socket::unpack_sockaddr_un", XS_Socket_unpack_sockaddr_un, file);
        (void)newXS("Socket::pack_sockaddr_in", XS_Socket_pack_sockaddr_in, file);
        (void)newXS("Socket::unpack_sockaddr_in", XS_Socket_unpack_sockaddr_in, file);
        (void)newXS("Socket::inet_ntop", XS_Socket_inet_ntop, file);
        (void)newXS("Socket::inet_pton", XS_Socket_inet_pton, file);
