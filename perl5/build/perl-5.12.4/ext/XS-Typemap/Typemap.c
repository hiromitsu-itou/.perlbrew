...
XS(boot_XS__Typemap)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("XS::Typemap::T_SV", XS_XS__Typemap_T_SV, file);
        (void)newXS("XS::Typemap::T_SVREF", XS_XS__Typemap_T_SVREF, file);
        (void)newXS("XS::Typemap::T_AVREF", XS_XS__Typemap_T_AVREF, file);
        (void)newXS("XS::Typemap::T_HVREF", XS_XS__Typemap_T_HVREF, file);
        (void)newXS("XS::Typemap::T_CVREF", XS_XS__Typemap_T_CVREF, file);
        (void)newXS("XS::Typemap::T_SYSRET_pass", XS_XS__Typemap_T_SYSRET_pass, file);
        (void)newXS("XS::Typemap::T_SYSRET_fail", XS_XS__Typemap_T_SYSRET_fail, file);
        (void)newXS("XS::Typemap::T_UV", XS_XS__Typemap_T_UV, file);
        (void)newXS("XS::Typemap::T_IV", XS_XS__Typemap_T_IV, file);
        (void)newXS("XS::Typemap::T_ENUM", XS_XS__Typemap_T_ENUM, file);
        (void)newXS("XS::Typemap::T_BOOL", XS_XS__Typemap_T_BOOL, file);
        (void)newXS("XS::Typemap::T_U_SHORT", XS_XS__Typemap_T_U_SHORT, file);
        (void)newXS("XS::Typemap::T_U_LONG", XS_XS__Typemap_T_U_LONG, file);
        (void)newXS("XS::Typemap::T_CHAR", XS_XS__Typemap_T_CHAR, file);
        (void)newXS("XS::Typemap::T_U_CHAR", XS_XS__Typemap_T_U_CHAR, file);
        (void)newXS("XS::Typemap::T_FLOAT", XS_XS__Typemap_T_FLOAT, file);
        (void)newXS("XS::Typemap::T_NV", XS_XS__Typemap_T_NV, file);
        (void)newXS("XS::Typemap::T_DOUBLE", XS_XS__Typemap_T_DOUBLE, file);
        (void)newXS("XS::Typemap::T_PV", XS_XS__Typemap_T_PV, file);
        (void)newXS("XS::Typemap::T_PTR_OUT", XS_XS__Typemap_T_PTR_OUT, file);
        (void)newXS("XS::Typemap::T_PTR_IN", XS_XS__Typemap_T_PTR_IN, file);
        (void)newXS("XS::Typemap::T_PTRREF_OUT", XS_XS__Typemap_T_PTRREF_OUT, file);
        (void)newXS("XS::Typemap::T_PTRREF_IN", XS_XS__Typemap_T_PTRREF_IN, file);
        (void)newXS("XS::Typemap::T_PTROBJ_OUT", XS_XS__Typemap_T_PTROBJ_OUT, file);
        (void)newXS("intObjPtr::T_PTROBJ_IN", XS_intObjPtr_T_PTROBJ_IN, file);
        (void)newXS("XS::Typemap::T_REF_IV_PTR_OUT", XS_XS__Typemap_T_REF_IV_PTR_OUT, file);
        (void)newXS("intRefIvPtr::T_REF_IV_PTR_IN", XS_intRefIvPtr_T_REF_IV_PTR_IN, file);
        (void)newXS("XS::Typemap::T_OPAQUEPTR_IN", XS_XS__Typemap_T_OPAQUEPTR_IN, file);
        (void)newXS("XS::Typemap::T_OPAQUEPTR_OUT", XS_XS__Typemap_T_OPAQUEPTR_OUT, file);
        (void)newXS("XS::Typemap::T_OPAQUEPTR_OUT_short", XS_XS__Typemap_T_OPAQUEPTR_OUT_short, file);
        (void)newXS("XS::Typemap::T_OPAQUEPTR_IN_struct", XS_XS__Typemap_T_OPAQUEPTR_IN_struct, file);
        (void)newXS("XS::Typemap::T_OPAQUEPTR_OUT_struct", XS_XS__Typemap_T_OPAQUEPTR_OUT_struct, file);
        (void)newXS("XS::Typemap::T_OPAQUE_IN", XS_XS__Typemap_T_OPAQUE_IN, file);
        (void)newXS("XS::Typemap::T_OPAQUE_OUT", XS_XS__Typemap_T_OPAQUE_OUT, file);
        (void)newXS("XS::Typemap::T_OPAQUE_array", XS_XS__Typemap_T_OPAQUE_array, file);
        (void)newXS("XS::Typemap::T_ARRAY", XS_XS__Typemap_T_ARRAY, file);
        (void)newXS("XS::Typemap::T_STDIO_open", XS_XS__Typemap_T_STDIO_open, file);
        (void)newXS("XS::Typemap::T_STDIO_close", XS_XS__Typemap_T_STDIO_close, file);
        (void)newXS("XS::Typemap::T_STDIO_print", XS_XS__Typemap_T_STDIO_print, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
