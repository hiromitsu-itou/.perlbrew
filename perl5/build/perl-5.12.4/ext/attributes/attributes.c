...
XS(XS_attributes__modify_attrs)
{
    ...
    SP -= items;
    {
#line 92 "attributes.xs"
    SV *rv, *sv;
#line 165 "attributes.c"
#line 95 "attributes.xs"
    if (items < 1) {
usage:
...
XS(XS_attributes__fetch_attrs)
{
    ...
    SP -= items;
    {
#line 113 "attributes.xs"
    SV *rv, *sv;
    cv_flags_t cvflags;
#line 202 "attributes.c"
#line 116 "attributes.xs"
    if (items != 1) {
usage:
...
XS(XS_attributes__guess_stash)
{
    ...
    SP -= items;
    {
#line 144 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 249 "attributes.c"
#line 147 "attributes.xs"
    if (items != 1) {
usage:
	croak_xs_usage(cv, "$reference");
    }
...
XS(XS_attributes_reftype)
{
    ...
    SP -= items;
    {
#line 191 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 312 "attributes.c"
#line 194 "attributes.xs"
    if (items != 1) {
usage:
	croak_xs_usage(cv, "$reference");
    }
...
XS(boot_attributes)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("attributes::_modify_attrs", XS_attributes__modify_attrs, file);
