...
XS(XS_GDBM_File_close)
{
	...
	gdbm_close(db);
#line 90 "GDBM_File.xs"
#line 305 "GDBM_File.c"
    }
    XSRETURN_EMPTY;
}
...
XS(XS_GDBM_File_DESTROY)
{
	...
	if (SvROK(ST(0))) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not a reference",
			"GDBM_File::DESTROY",
			"db");
#line 96 "GDBM_File.xs"
	gdbm_close(db);
	safefree(db);
#line 335 "GDBM_File.c"
    }
    XSRETURN_EMPTY;
}
...
XS(XS_GDBM_File_filter_fetch_key)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "GDBM_File")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"db", "GDBM_File");
#line 169 "GDBM_File.xs"
	    DBM_setFilter(db->filter_fetch_key, code) ;
#line 725 "GDBM_File.c"
    }
    XSRETURN(1);
}
...
XS(XS_GDBM_File_filter_store_key)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "GDBM_File")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"db", "GDBM_File");
#line 177 "GDBM_File.xs"
	    DBM_setFilter(db->filter_store_key, code) ;
#line 756 "GDBM_File.c"
    }
    XSRETURN(1);
}
...
XS(XS_GDBM_File_filter_fetch_value)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "GDBM_File")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"db", "GDBM_File");
#line 185 "GDBM_File.xs"
	    DBM_setFilter(db->filter_fetch_value, code) ;
#line 787 "GDBM_File.c"
    }
    XSRETURN(1);
}
...
XS(XS_GDBM_File_filter_store_value)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "GDBM_File")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"db", "GDBM_File");
#line 193 "GDBM_File.xs"
	    DBM_setFilter(db->filter_store_value, code) ;
#line 818 "GDBM_File.c"
    }
    XSRETURN(1);
}
...
XS(boot_GDBM_File)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("GDBM_File::constant", XS_GDBM_File_constant, file);
        (void)newXS("GDBM_File::TIEHASH", XS_GDBM_File_TIEHASH, file);
        (void)newXS("GDBM_File::close", XS_GDBM_File_close, file);
        (void)newXS("GDBM_File::DESTROY", XS_GDBM_File_DESTROY, file);
        (void)newXS("GDBM_File::FETCH", XS_GDBM_File_FETCH, file);
        (void)newXS("GDBM_File::STORE", XS_GDBM_File_STORE, file);
        (void)newXS("GDBM_File::DELETE", XS_GDBM_File_DELETE, file);
        (void)newXS("GDBM_File::FIRSTKEY", XS_GDBM_File_FIRSTKEY, file);
        (void)newXS("GDBM_File::NEXTKEY", XS_GDBM_File_NEXTKEY, file);
        (void)newXS("GDBM_File::reorganize", XS_GDBM_File_reorganize, file);
        (void)newXS("GDBM_File::sync", XS_GDBM_File_sync, file);
        (void)newXS("GDBM_File::EXISTS", XS_GDBM_File_EXISTS, file);
        (void)newXS("GDBM_File::setopt", XS_GDBM_File_setopt, file);
        (void)newXS("GDBM_File::filter_fetch_key", XS_GDBM_File_filter_fetch_key, file);
        (void)newXS("GDBM_File::filter_store_key", XS_GDBM_File_filter_store_key, file);
        (void)newXS("GDBM_File::filter_fetch_value", XS_GDBM_File_filter_fetch_value, file);
        (void)newXS("GDBM_File::filter_store_value", XS_GDBM_File_filter_store_value, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
